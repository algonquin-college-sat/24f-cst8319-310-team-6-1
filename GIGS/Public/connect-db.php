...
class DB {
    ...
    public function get_user($id) {
        $sql = $this->db->query("SELECT * FROM LinkedinUser WHERE in_uid = '$id'");
    ...
    public function upsert_user($arr_data = array()) {
        ...
        if(!$user) {
            // insert the user
            $this->db->query("INSERT INTO LinkedinUser(in_uid, name, email, picture) VALUES('$uid', '$name', '$email', '$picture')");
        } else {
            // update the user
