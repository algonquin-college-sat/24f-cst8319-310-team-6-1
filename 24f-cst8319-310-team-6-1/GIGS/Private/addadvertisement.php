<?php
   ...
   if (isset($_POST['insert'])) {
    ...
    $sql = "INSERT INTO gigadvertisements (country, city, domain, gigworkername, duration, description, hourly_paid)
            VALUES ('$country', '$city', '$domain', '$gigworkername', '$duration', '$description', '$hourlyPaid')";

    $result = $db->query($sql);

if ($result) {
        // Set session variables for notification
        $_SESSION['notification_message'] = "New gig advertisement added successfully!";
        $_SESSION['notification_type'] = "new_gig";
        header('Location: ' . "../Private/displayadvertisement.php");
...
<head>
    ...
    <title>Add Job Advertisement</title>
    <style>
        body {
...
<?php
    ...
    <div class="container">
        <h1>Add New Gig Worker Advertisement</h1>
        <form action="" method="POST">
            ...
            <label for="gigworkername">Gig Worker Name:</label>
            <input type="text" id="gigworkername" name="gigworkername" required>
            ...
            <br>
            <input type="submit" value="Add Job Advertisement" name="insert" style="font-size: 20px; ">
        </form>
    </div>
