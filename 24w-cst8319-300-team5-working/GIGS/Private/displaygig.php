...
<body>
    ...
    <h1>GIG Worker Profiles<br><a href="addform.php"><button id="addgig">Add New Gig Work</button><br></a></h1>
    <div class="container">
...
<br>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<br><a href="../../newchat/indexchat.php" target="_blank"><button id="chat">Chat</button></a> ';
                    echo '<a href="./workerreviews.php?userName=' . urlencode($row['userName']) . '" target="_blank"><button id="review">Leave Feedback</button></a> ';
